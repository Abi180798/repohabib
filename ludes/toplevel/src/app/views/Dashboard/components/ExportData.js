  ...
  return (
    <div>
      <ReactHTMLTableToExcel
        table="table-to-xls"
        filename={`Laporan Tingkat Penjualan ${
      ...
      >
        <tr>
          <th colspan={3}>Laporan Tingkat Penjualan</th>
          <th></th>
          <th></th>
        ...
        <tr />
        {
          state.data&&state.data.map((row, i) => (
            <tr>
              ...
              >
                {thousandSeparator(parseFloat(row.discount).toFixed(0))}
              </td>
              <td
                style={{
                  textAlign: "right",
              ...
              >
                {thousandSeparator(parseFloat(row.mdr).toFixed(0))}
              </td>
              <td
                style={{
                  textAlign: "right",
              ...
              >
                {thousandSeparator(parseFloat(row.pajak).toFixed(0))}
              </td>
              <td
                style={{
                  textAlign: "right",
